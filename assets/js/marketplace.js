...
const PRODUCTS = [
  ...
  { id:49, name:"EcoMart Organics", cat:"grocery", emoji:"🛒", image:"../assets/images/EcoMart Organics.png", company:"EcoMart Organics", price:990, oldPrice:null, rating:4.5, reviews:61, badge:"new", isNew:true, tags:["Organic","Groceries","Eco"], desc:"Organic everyday grocery essentials from EcoMart Organics, curated for health-conscious families and small retailers.", delivery:"Island-wide: 2–4 days" },
  { id:50, name:"Fashion Hub Clothing", cat:"fashion", emoji:"👗", image:"../assets/images/Fashion Hub.avif", company:"Fashion Hub", price:3200, oldPrice:3900, rating:4.4, reviews:74, badge:"sale", isNew:false, tags:["Fashion","Apparel","Style"], desc:"Trendy fashion picks for everyday wear, office use, and casual outings from Fashion Hub.", delivery:"Island-wide: 2–4 days" },
  { id:51, name:"HomeStyle Decor", cat:"home", emoji:"🛋️", image:"../assets/images/HomeStyle Decor.webp", company:"HomeStyle Decor", price:2500, oldPrice:null, rating:4.6, reviews:48, badge:"", isNew:false, tags:["Decor","Home","Interior"], desc:"Modern home decor items designed to refresh living spaces with a clean, stylish look.", delivery:"Island-wide: 2–3 days" },
  { id:52, name:"Mobile Hub Electronics", cat:"electronics", emoji:"📱", image:"../assets/images/Mobile Hub Electronics.png", company:"Mobile Hub Electronics", price:14500, oldPrice:16500, rating:4.7, reviews:83, badge:"hot", isNew:false, tags:["Mobile","Electronics","Devices"], desc:"Smartphone accessories and mobile essentials from Mobile Hub Electronics for daily and business use.", delivery:"Island-wide: 2–3 days" },
  { id:53, name:"Rice Cooker 1.8L", cat:"home", emoji:"🍚", image:"../assets/images/Rice Cooker.jpg", company:"KitchenPro Lanka", price:6900, oldPrice:null, rating:4.5, reviews:37, badge:"", isNew:false, tags:["Kitchen","Cooker","Appliance"], desc:"Compact 1.8L rice cooker for convenient daily cooking at home, in offices, and small food stalls.", delivery:"Island-wide: 2–4 days" },
  { id:54, name:"TechZone Electronics Accessories", cat:"electronics", emoji:"🔌", image:"../assets/images/TechZone Electronics add.png", company:"TechZone Lanka", price:4200, oldPrice:null, rating:4.3, reviews:29, badge:"", isNew:false, tags:["Accessories","Tech","Electronics"], desc:"Extra electronic accessories and add-ons from TechZone for upgraded device setups and replacements.", delivery:"Island-wide: 2–3 days" },
];
